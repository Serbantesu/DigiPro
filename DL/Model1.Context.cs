...
namespace DL
{
    ...
    public partial class JCervantesDigiProEntities1 : DbContext
    {
        public JCervantesDigiProEntities1()
            : base("name=JCervantesDigiProEntities1")
        {
        }
        ...
        public virtual ObjectResult<MateriasSinAsignar_Result> MateriasSinAsignar(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriasSinAsignar_Result>("MateriasSinAsignar", idAlumnoParameter);
        }
    
        public virtual int AlumnoMateriaAdd(Nullable<int> idMateria, Nullable<int> idAlumno)
        {
            var idMateriaParameter = idMateria.HasValue ?
                new ObjectParameter("IdMateria", idMateria) :
                new ObjectParameter("IdMateria", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoMateriaAdd", idMateriaParameter, idAlumnoParameter);
        }
        ...
        public virtual ObjectResult<MateriaGetByAlumno_Result> MateriaGetByAlumno(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MateriaGetByAlumno_Result>("MateriaGetByAlumno", idAlumnoParameter);
        }
    }
}
